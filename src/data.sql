...
/* Medicos */
INSERT INTO medicos (apellido, correo, direccion, estado, fechaNac, nombre, sexo, telefono, id_especialidad, id_localidad, usuario_c)
VALUES
('Gonzalez', 'gonzalez@example.com', 'Calle 123', 1, '1980-05-15', 'Juan', 'M', '123456789', 1, 2, 'medico1'),
('Perez', 'perez@example.com', 'Avenida 456', 1, '1975-02-20', 'Maria', 'F', '987654321', 2, 2, 'medico2'),
('Rodriguez', 'rodriguez@example.com', 'Boulevard 789', 1, '1988-11-11', 'Jorge', 'M', '112233445', 3, 2, 'medico3'),
('Martinez', 'martinez@example.com', 'Pasaje 101', 1, '1992-09-25', 'Lucia', 'F', '223344556', 4, 2, 'medico4'),
('Lopez', 'lopez@example.com', 'Calle 202', 1, '1985-07-30', 'Pedro', 'M', '334455667', 5, 2, 'medico5'),
('Fernandez', 'fernandez@example.com', 'Avenida 303', 1, '1978-12-12', 'Ana', 'F', '445566778', 6, 2, 'medico6'),
('Garcia', 'garcia@example.com', 'Boulevard 404', 1, '1990-03-14', 'Miguel', 'M', '556677889', 7, 2, 'medico7'),
('Hernandez', 'hernandez@example.com', 'Pasaje 505', 1, '1983-08-22', 'Elena', 'F', '667788990', 8, 2, 'medico8'),
('Torres', 'torres@example.com', 'Calle 606', 1, '1986-01-01', 'Jorge', 'M', '778899001', 9, 2, 'medico9'),
('Sanchez', 'sanchez@example.com', 'Avenida 707', 1, '1993-04-04', 'Isabel', 'F', '889900112', 1, 2, 'medico10'),
('Rojas', 'rojas@example.com', 'Calle 808', 1, '1982-06-15', 'Julia', 'F', '998877665', 2, 2, 'medico11'),
('Gimenez', 'gimenez@example.com', 'Avenida 909', 1, '1976-03-10', 'Gabriel', 'M', '887766554', 3, 2, 'medico12'),
('Moreno', 'moreno@example.com', 'Boulevard 1010', 1, '1991-09-20', 'Valentina', 'F', '776655443', 4, 2, 'medico13'),
('Silva', 'silva@example.com', 'Pasaje 1112', 1, '1984-12-05', 'Mateo', 'M', '665544332', 5, 2, 'medico14'),
('Luna', 'luna@example.com', 'Calle 1213', 1, '1987-07-08', 'Camila', 'F', '554433221', 6, 2, 'medico15');
